...
- **Biobank** inneholder informasjon om en juridisk enhet eller del av en juridisk enhet som utfører biobankvirksomhet, i samsvar med ISO 20387:2018. Biobanker inneholder ikke prøver og data direkte, da de er vert for prøvesamlinger der prøvene og dataene er innebygd. På biobanknivå representeres kun attributter knyttet til de organisatoriske aspektene ved biobankene.
...
å beskrive dataprodukter og prøvesamlinger
...
Klassen Variabelgruppe brukes også til å definere prøvetyper.
...
Statistikk brukes også for kvantitativ representasjon av en prøvetype innenfor en prøvesamling.
...
- **Prøvesamling** er en variant av klassen Datasamling. 
En datakilde kan inneholde både Datasamlinger og Prøvesamlinger der prøvesamling er en systematisk samling av biologiske prøver.

- **Prøvetype** er en variant av klassen Variabelgruppe. Prøvetype beskriver hvilke typer biologisk materiale som er lagret i en prøvesamling

- **Prøvetypeattributt** er en variant av klassen Variabel som beskriver egenskaper knyttet til en bestemt prøvetype.
...
[link=images/Informasjonsmodell_utvidet.jpg, title="Logisk informasjonsmodell for metadata om helsedata"]image::images/Informasjonsmodell_utvidet.jpg[width=100%]
image::images/Informasjonsmodell_utvidet.jpg[]
...
3. En datakilde eller delkilde inneholder én eller flere datasamlinger og/eller prøvesamlinger.
...
12. Hver prøvesamling refererer til en eller flere Biobanker.

13. Når en variabelgruppe representerer en prøvetype, kan den referere til statistikk. Referansen er koblet til Prøvesamling.

14. En biobank er en selvstendig enhet som kan referere til fra flere prøvesamlinger.
