...
[link=images/informasjonsmodell_med_prøvesamlinger.png, title="Logisk informasjonsmodell for metadata om helsedata"]image::images/informasjonsmodell_med_prøvesamlinger.png[width=100%]
