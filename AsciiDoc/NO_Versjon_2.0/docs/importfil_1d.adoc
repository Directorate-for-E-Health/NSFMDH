...
Importfil 1d-Statistikk brukes til å presentere enkel statistikk for et utvalg av datakildens variabler og for prøvetyper i en prøvesamling.
...
For prøvesamlinger skal statistikk vise antall prøver pr. prøvetype.
Det betyr at statistikken skal kobles til klassen for Variabelgruppe og ikke til variabel og kodeverdi. Denne statistikken vil alltid være av type "Akkumulert"
...
For variabelstatistikk: Store bokstaver, uten mellomrom og æ, ø, å. Prefiks S for statistikk,
underscore, årstall, kortnavn på datakilden, punktum, datasamling,
punktum, variabelnavn, punktum KodeverkLokalID, f.eks.
S++_++NPR++_++2024.BUP.KJONN.1
For prøvetypestatistikk: Store bokstaver, uten mellomrom og æ, ø, å. Prefiks S for statistikk,
underscore, årstall, kortnavn på datakilden, punktum, datasamling,
punktum, prøvetype (ref. variabelgruppe), f.eks.
S++_++TR++_++2024.TR5_S2.SERUM
