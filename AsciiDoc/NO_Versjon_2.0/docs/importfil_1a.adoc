...
Importfil 1a-Kildemetadata brukes til å beskrive både datakilden, eventuelle delkilder og underliggende datasamlinger og/eller prøvesamlinger, på et overordnet nivå ved hjelp av et sett standardiserte properties.

Ihht Prop. 63 (2019-2020) skal dataprodukt inneholde informasjon om dataproduktets bruksområder (Anbefalte bruksområder og Rettsgrunnlag). Dette representeres som metadata om datasamlinger i importfilen definert under. Anbefalte bruksområder er definert i property 16, mens Rettsgrunnlag er definert i properties 30-37. 
...
Datasamling kan også beskrive en prøvesamling
...
Kort beskrivende navn på datakilden, delkilden eller datasamlingen/prøvesamlingen.
...
Brukes for å angi fra når en datakilde, delkilde eller datasamling eller prøvesamling er
...
| |16 |AnbefalteBruksomraader |Valgfri |En beskrivelse av hvilke
...
det tilgjengelige datagrunnlaget oppdateres i datakilden.
...
innbygg*erne som inngår i datakilden, delkilden eller datasamlingen.
...
3 = Datasamling eller Prøvesamling (ref. Kildetype)
...
|_Prøvesamling_ |48 |ProvesamlingID |Valgfri |PrøvesamlingsID. Teknisnk ID som tildeles fra BBMRI-Eric etter overføring/registrering.
NB! Denne opprettes av BBMRI-Eric ved første gangs eksport og må etterregistreres.

| |49 |Kjønn |Valgfri |Angir hvilke kjønn som er representert i prøvesamlingen. Kodes i henhold til MIABIS
...
| |50 |LavesteAlder |Valgfri |Laveste alder på person i prøvesamlingen


| |51 |HoyesteAlder |Valgfri |Høyeste alder på person i prøvesamlingen


| |52 |LavesteAlderEnhet |Valgfri |Enhet for laveste alder på person i prøvesamlingen
...
| |53 |HoyesteAlderEnhet |Valgfri |Enhet for høyeste alder på person i prøvesamlingen
...
| |54 |DatasettType |Valgfri |Datasett type
...
| |55	|LagringsTemperatur	|Valgfri	|Lagringstemperatur
...
| |56	|Kontekst	|Valgfri	|Kontekst for prøveinnsamling
...
| |57	|StudieDesign	|Valgfri	|Studiedesignet som beskriver hvordan/hvorfor prøvene ble samlet inn
...
| |58	|BetingelserForBruk	|Valgfri	|Betingelser for tilgjengelighet og bruk
...
| |59	|PrøvesamlingsStatus	|Valgfri	|Status for prøvesamlingen
...
| |60	|AntallDonorer	|Valgfri	|Antall donorer i prøvesamlingen

| |61	|InklusjonsKriterier	|Valgfri	|Inklusjonskriterier
...
| |62	|KontakpersonFornavn	|Valgfri	|Kontaktpersonens fornavn
| |63	|KontakpersonEtternavn	|Valgfri	|Kontaktpersonens etternavn
| |64	|KontakpersonEmail	|Valgfri	|Kontaktpersonens epost
| |65	|KontakpersonTelefon	|Valgfri	|Kontaktpersonens telefonnummer


|_Tillegg_ |66-N |Mulige tilleggsproperties |Valgfri a|
