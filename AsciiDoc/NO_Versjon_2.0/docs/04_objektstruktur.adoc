...
12. BIOBANK importeres som Code System og blir et selvstendig Core Code System. Biobank blir da en uavhengig klasse og kan mappes til med prøvesamlinger fra ulike Kilder
