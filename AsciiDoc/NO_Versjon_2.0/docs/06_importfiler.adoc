...
|Biobank |Eksempel: BB_HUNT Prefix + «_» + Biobank.KortNavn 
|===
...
Biobankere defineres som frittstående Code-systems. 


Tabell 3: Hierarkisk oppbygging av importfilene
[options="header"]
|===
|Filtype |Code |Parent Code |Hierarki |Preferred Term
|1a: Kildemetadata |DAR | ||Dødsårsaksregisteret
|1a: Kildemetadata |K_DAR |DAR ||KILDEMETADATA
|1b: Variabelmetadata |V_DAR |DAR ||VARIABELMETADATA
|1c: Versjon |N_DAR |DAR ||VERSJON
|1d: Statistikk |S_DAR |DAR ||STATISTIKK
|1d: Statistikk |S_DAR_2024.DAR |S_DAR ||DØDSÅRSAKSREGISTERET 2017
|1e: Variabelgruppe |G_DAR |DAR ||VARIABELGRUPPE
|1f: Instrument |I_DAR |DAR ||INSTRUMENT
|3: Biobank |FHI | ||Biobanken ved Folkehelseinstituttet
|3: Biobank |BB_FHI |FHI ||BIOBANK
|===
...
[options="header"]
|===
|Code |ParentCode |Hierarchy |PreferredTerm
|KK_KODEVERK*| ||KILDEKODEVERK
|KK_ALLE* |KK_KODEVERK| |ALLE
|KK_EIER* |KK_KODEVERK|| EIER
|KK_KILDE* |KK_KODEVERK ||KILDE 
|KK_<Eier>** |KK_EIER ||<Kortnavn>
...
|KK_FHI |KK_EIER|| FHI
|KK_DAR| KK_FHI|| DØDSÅRSAKSREGISTERET
