...
Ikke alle klassene er obligatoriske, og enkelte vil kun være relevant for kun
...
hierarkisk. Variabelgruppe erstatter den nå utgåtte propertien TemaLokalt, men vil
