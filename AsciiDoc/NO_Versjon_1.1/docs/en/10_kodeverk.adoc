= Administrative og helsefaglige kodeverk [[administrative_og_helsefaglige_kodeverk]]

Med administrative kodeverk menes her kodeverkene som per i dag finnes på volven.no.
...
egne mappingfiler. Target code i mappingfilen vil være samme OID som brukes i Volven.
